...
PARAMETER="$@"
docker-compose -p "$PROJECTNAME" -f docker-data/config/base/docker-compose.yml exec php bash -c "sudo -u www-data bash -l -c 'php $PARAMETER'"
...
docker exec -it %PROJECTNAME%_php_1 bash -c "sudo -u www-data bash -l -c 'php %*'"

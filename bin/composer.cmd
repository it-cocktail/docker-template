...
PARAMETER="$@"
docker-compose -p "$PROJECTNAME" -f docker-data/config/docker-compose.yml exec php bash -c "sudo -u www-data bash -l -c 'composer $PARAMETER'"
...
docker exec -it %PROJECTNAME%_php_1 bash -c "sudo -u www-data bash -l -c 'composer %*'"
